...
class OperatorResourceList:
    ...
    def _validate_operator_balance(self):
        ...
        sol_balance = self._neon_tx_sender.get_sol_balance(self._resource.public_key())
    ...
    def _create_ether_account(self) -> EthereumAddress:
        ...
        account_info = self._neon_tx_sender.get_account_info(solana_address)
        ...
        stage.balance = self._neon_tx_sender.get_multiple_rent_exempt_balances_for_size([stage.size])[0]
        stage.build()
    ...
    def _create_perm_accounts(self, seed_list):
        ...
        info_list = self._neon_tx_sender.get_account_info_list(account_list)
        balance = self._neon_tx_sender.get_multiple_rent_exempt_balances_for_size([STORAGE_SIZE])[0]
